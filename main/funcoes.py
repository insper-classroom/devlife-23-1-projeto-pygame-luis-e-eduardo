...
class Telas():
    def __init__(self, window): 
        ...
        self.jogador = Jogador(self.plataforma,self.monstros,self.estrela, self.coracao,self.gorilas,self.banas, self.pocao,self.plataformas_quebraveis,self.tiro_monstro)
...
class Jogador(pygame.sprite.Sprite):
    ...
    def __init__(self,chao,monstros,estrela, coracao, gorilas, bananas, pocao, plataformas_quebraveis, tiro_banana):
